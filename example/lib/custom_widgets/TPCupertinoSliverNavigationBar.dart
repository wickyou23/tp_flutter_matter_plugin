...
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/bars/navigation-bars/>
class TPCupertinoSliverNavigationBar extends StatefulWidget {
  ...
  @override
  State<TPCupertinoSliverNavigationBar> createState() =>
      _TPCupertinoSliverNavigationBar();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _TPCupertinoSliverNavigationBar
    extends State<TPCupertinoSliverNavigationBar> {
  late _NavigationBarStaticComponentsKeys keys;
    ...
    return MediaQuery(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _LargeTitleNavigationBarSliverDelegate(
          ...
          middleBackgroundColor: CupertinoDynamicColor.maybeResolve(
              widget.middleBackgroundColor, context),
        ),
      ),
    );
  }
